...
public class ZombieDamage : MonoBehaviour
{
    ...
    public SphereCollider RhandCollider;                   //좀비 손 콜라이더 - 복잡한 구조라서 찾기 힘들어서 직접 끌어서 넣음.
    public SphereCollider LhandCollider;                   //좀비 손 콜라이더 - 복잡한 구조라서 찾기 힘들어서 직접 끌어서 넣음.
    ...
    {
        RhandCollider.enabled = true;                           //손 콜라이더 활성화     
        LhandCollider.enabled = true;                           //손 콜라이더 활성화     
    }

    //public
    public void PunchColliderDisable()                          //손 콜라이더 비활성화 함수 
    {
        RhandCollider.enabled = false;                          //손 콜라이더 비활성화
        LhandCollider.enabled = false;                          //손 콜라이더 비활성화
    }
